...
exports.getFavorites = async (req, res) => {
    try {
        ...
        // Filtrar los favoritos que tienen una película válida
        const validFavorites = favorites.filter(favorite => favorite.movie !== null);
        
        // Eliminar los favoritos inválidos de la base de datos
        const invalidFavorites = favorites.filter(favorite => favorite.movie === null);
